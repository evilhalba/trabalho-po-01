...
<thead>
		...
		<c:forEach items="${ clientes }" var="c"> 
			<tr>
				...
				<td>${ c.tel } </td>
				<td>
					<a href="<c:url value="/DetalhesClienteServlet?id=${c.id }" />"><button type="button" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> Detalhes</button></a>
					<a href="<c:url value="/DeletarClienteServlet?id=${c.id }"  />" onclick="return confirm('Deseja realmente deletar?')"><button type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Deletar</button></a>
