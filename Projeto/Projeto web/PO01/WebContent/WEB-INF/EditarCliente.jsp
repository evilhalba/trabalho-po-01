...
<title>Editar Cliente ${ cliente.nome }</title>
</head>
<body>
...
<c:url value="/EditarClienteServlet" var="link" />
	<form method="POST" action="${ link }">
	  ...
	  <div class="form-group col-md-4">
  	  	...
  	  	<input type="text" class="form-control" id="cnh" name="cnh" placeholder="CNH" value="${ cliente.CNH }" >
  	  </div>
	</div>
	...
	<div class="row">
  	  <div class="form-group col-md-3">
  	  	...
  	  	<input type="text" class="form-control" id="tel" name="tel" placeholder="Telefone" value="${ cliente.tel }" >
  	  </div>
  	  
  	  <div class="row">
  	  <div class="form-group col-md-3">
  	  	<label for="end">Endereço:</label>
  	  	<input type="text" class="form-control" id="end" name="end" placeholder="Endereco" value="${ cliente.end }">
  	  </div>
